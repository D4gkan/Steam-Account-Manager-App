...
Use JDK 21 and Android SDK 36. Set `JAVA_HOME` and `ANDROID_HOME` for your machine.

Run these commands from `Mobile/`. See the [unified README](../README.md) for current release verification.
