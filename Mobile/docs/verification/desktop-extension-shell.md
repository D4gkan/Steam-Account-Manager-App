...
On 2026-09-09, the official CSFloat popup regression passed on the Android 17
emulator, covering Back to website, reopening the enabled extension, and Android
Back. The desktop user-agent/viewport and collapsed-controls test passed in the
preceding run. The user also confirmed desktop view and the return controls work
on the connected Samsung Galaxy S25 Ultra.
